...
const Header = () => (
    <header className="sticky  top-0 z-50 text-white backdrop-blur-md border-b border-gray-800">
      ...
      >
        ...
        <main className="container mx-auto px-4 py-16 sm:py-24 max-w-4xl">
          ...
          <section className="text-center mb-16">
            <h1
              className={`${geistMono.variable} font-mono text-5xl text-white sm:text-6xl font-extrabold tracking-tighter mb-4 text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400`}
            >
              Fale Comigo
            </h1>
            <p className="text-xl text-white max-w-3xl mx-auto">
              Seja para uma proposta de trabalho, parceria ou apenas dizer um
              "olá".
            </p>
          </section>
              ...
              <form className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    id="nome"
                    className="w-full px-4 py-2  border border-gray-700 rounded-lg text-blackfocus:ring-indigo-500 focus:border-indigo-500"
                ...
                <div>
                  ...
                  <textarea
                    id="mensagem"
                    rows="4"
                    className="w-full px-4 py-2 border border-gray-700 rounded-lg text-white focus:ring-indigo-500 focus:border-indigo-500"
                    placeholder="Detalhe sua proposta ou dúvida..."
                  ></textarea>
                </div>
                <button
                  type="submit"
                  className="w-full px-4 py-3 bg-Card hover:bg-indigo-700 text-white font-semibold rounded-lg transition-all duration-300 flex items-center justify-center space-x-2"
                >
                  Enviar Mensagem
                </button>
              </form>
