...
const FullProjectCard = ({ project }) => (
  <div className="bg-Card rounded-xl shadow-2xl overflow-hidden border border-gray-700 transition-all duration-300 hover:border-indigo-500 hover:shadow-indigo-500/20">
...
export default function ProjetosPage() {
  ...
  return (
    <div className={`${geistSans.variable} font-sans min-h-screen`}>
      ...
      <main className="container mx-auto px-4 py-16 sm:py-24 max-w-6xl">
        <section className="text-center mb-16">
          ...
          <p className="text-xl  max-w-3xl mx-auto">
            Uma coleção de trabalhos que demonstram minhas habilidades em
            design, desenvolvimento e otimização com React.
          </p>
        </section>
        ...
        <div className="text-center mt-20 p-8 bg-Card rounded-xl border border-gray-700">
          ...
          <Link
            href="/contato"
            className="px-6 py-3 bg-cyan-950 hover:bg-indigo-700 text-white font-semibold rounded-lg shadow-xl transition-all duration-300 transform hover:scale-[1.02]"
          >
